...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#0f0a1a] to-[#0a0610] text-muted-foreground relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute top-0 left-1/3 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground/70 mb-6 max-w-sm leading-relaxed">
            ...
            {/* Support Email */}
            <div className="mb-6">
              <p className="text-sm text-muted-foreground mb-2">Suporte:</p>
              <a
              ...
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-muted border border-purple-500/20 rounded-lg text-white placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
                  />
                </div>
                <button className="px-4 py-2 bg-primary text-primary-foreground hover:opacity-90 transition-all duration-150 rounded-lg text-sm">
                  Assinar
                </button>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-4 h-4 text-muted-foreground/70 group-hover:text-purple-400 transition-colors" />
                  </a>
                );
              })}
            </div>
            ...
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-sm text-muted-foreground/70 hover:text-purple-400 transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
