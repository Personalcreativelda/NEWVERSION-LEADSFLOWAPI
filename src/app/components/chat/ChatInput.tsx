    ...
    <div className="border-t border-border bg-card p-4 rounded-b-2xl">
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="p-2 text-muted-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-colors flex-shrink-0"
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="w-full px-4 py-2.5 pr-12 bg-muted border border-border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed text-sm"
