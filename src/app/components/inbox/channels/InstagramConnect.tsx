...
export function InstagramConnect({ isOpen, onClose, onSuccess, editingChannel }: InstagramConnectProps) {
    ...
    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fadeIn">
            {/* Modal */}
            <div
                className="relative w-[95vw] max-w-3xl rounded-2xl border shadow-2xl overflow-hidden animate-fadeIn max-h-[90vh] flex flex-col"
                style={{ 
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 w-full sm:w-auto px-4 py-3 rounded-lg text-sm font-medium text-white bg-primary text-primary-foreground hover:opacity-90 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
                                    {loading ? (
                                        <>
