                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="p-2 text-muted-foreground/70 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors"
                                        title="Editar"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="p-2 text-muted-foreground/70 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                                        title="Excluir"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
