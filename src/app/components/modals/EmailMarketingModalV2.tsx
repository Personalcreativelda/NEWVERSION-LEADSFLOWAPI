...
export default function EmailMarketingModalV2({
 ...
 <DialogContent className="bg-card rounded-2xl max-w-4xl w-full shadow-lg max-h-[90vh] overflow-y-auto">
 ...
 <div>
 <p className="font-medium text-foreground">{detail.nome}</p>
 ...
 {/* Templates */}
 <div>
 <Label className="text-foreground/80 mb-3 block">
 📝 Templates Prontos
 </Label>
 ...
 {/* Destinatários */}
 <div>
 <Label className="text-foreground/80 mb-2">
 Destinatários ({selectedLeads.length})
 </Label>
 <div className="bg-muted/50 rounded-lg p-4 max-h-48 overflow-y-auto">
 {selectedLeads.length === 0 ? (
 <p className="text-sm text-foreground/80 text-center py-2">
 ...
 {/* Assunto */}
 <div>
 <Label htmlFor="subject" className="text-foreground/80 mb-2">
 Assunto do Email
 </Label>
 <Input
 id="subject"
 ...
 {/* Mensagem */}
 <div>
 <Label htmlFor="message" className="text-foreground/80 mb-2">
 Mensagem
 </Label>
 <Textarea
 id="message"
 ...
 💡 Variáveis disponíveis: <code className="bg-muted px-1 rounded">{'{nome}'}</code>, <code className="bg-muted px-1 rounded">{'{email}'}</code>, <code className="bg-muted px-1 rounded">{'{telefone}'}</code>, <code className="bg-muted px-1 rounded">{'{interesse}'}</code>
 </p>
 </div>
 ...
 {/* Footer */}
 {!showReport && (
 <div className="sticky bottom-0 bg-muted/50 border-t border-border px-6 py-4 flex justify-between items-center rounded-b-2xl">
