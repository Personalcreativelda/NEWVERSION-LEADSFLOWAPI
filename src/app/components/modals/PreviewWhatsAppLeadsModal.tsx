...
export default function PreviewWhatsAppLeadsModal({
 ...
 <div className="bg-card text-foreground rounded-2xl shadow-xl border border-border max-w-4xl w-full max-h-[90vh] flex flex-col">
 {/* Header */}
 ...
 <div className="mb-4 flex items-center justify-between p-3 bg-muted/50/50 rounded-lg">
 ...
 className="p-2 text-foreground/80 hover:bg-muted/50 rounded-lg transition-colors"
 title="Cancelar"
 >
 <X className="w-4 h-4" />
 </button>
 ...
 onClick={onClose}
 disabled={loading}
 className="px-6 py-2.5 text-foreground/80 hover:bg-muted/50 rounded-lg transition-colors disabled:opacity-50"
 >
 Cancelar
 </button>
 <button
